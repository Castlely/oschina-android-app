...
public class CircleFlowIndicator extends View implements FlowIndicator, AnimationListener {
    ...
    public CircleFlowIndicator(Context context, AttributeSet attrs) {
        ...
        circleSeparation = a.getDimension(R.styleable.CircleFlowIndicator_circleSeparation,
            2 * radius + radius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            canvas.drawCircle(leftPadding + radius + (iLoop * circleSeparation) + centeringOffset,
        ...
        canvas.drawCircle(leftPadding + radius + cx + centeringOffset, getPaddingTop() + radius,
            radius + activeRadius, mPaintActive);
    }
    ...
    private int measureWidth(int measureSpec) {
        ...
        // Calculate the width according the views count
            ...
            result = (int) (getPaddingLeft() + getPaddingRight() + (count * 2 * radius)
                            + (count - 1) * temp + 1);
