...
public class ListViewMessageDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //获取控件对象
            listItemView.userface1 = (ImageView) convertView
                .findViewById(R.id.messagedetail_listitem_userface1);
            listItemView.userface2 = (ImageView) convertView
                .findViewById(R.id.messagedetail_listitem_userface2);
            ...
            listItemView.date = (TextView) convertView
                .findViewById(R.id.messagedetail_listitem_date);
            listItemView.contentll = (LinearLayout) convertView
                .findViewById(R.id.messagedetail_listitem_contentll);
            listItemView.client = (TextView) convertView
                .findViewById(R.id.messagedetail_listitem_client);
        ...
        listItemView.username.setLinkText("<font color='#0e5986'><b>" + msg.getAuthor()
                                          + "</b></font>：" + msg.getContent());
