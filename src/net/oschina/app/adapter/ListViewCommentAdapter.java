...
public class ListViewCommentAdapter extends MyBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.relies = (LinearLayout) convertView
                .findViewById(R.id.comment_listitem_relies);
        ...
        if (comment.getReplies().size() > 0) {
            ...
            for (Reply reply : comment.getReplies()) {
                ...
                tv2.setText(reply.rauthor + "(" + StringUtils.friendly_time(reply.rpubDate) + ")："
                            + reply.rcontent);
