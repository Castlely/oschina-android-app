...
public class ListViewMessageAdapter extends MyBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (msg.getSenderId() == ac.getLoginUid()) {
            UIHelper.parseMessageSpan(listItemView.username, msg.getFriendName(), msg.getContent(),
                "发给 ");
        } else {
            UIHelper.parseMessageSpan(listItemView.username, msg.getSender(), msg.getContent(), "");
        }
    ...
    private View.OnClickListener linkViewClickListener = new View.OnClickListener() {
                                                           public void onClick(View v) {
                                                               if (!isLinkViewClick()) {
                                                                   Messages msg = (Messages) v
                                                                       .getTag();
                                                                   UIHelper.showMessageDetail(
                                                                       v.getContext(),
                                                                       msg.getFriendId(),
                                                                       msg.getFriendName());
                                                               }
