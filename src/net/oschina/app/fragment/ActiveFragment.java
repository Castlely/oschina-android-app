...
public class ActiveFragment extends ListFragment implements LoadListDataCallbacks {
    ...
    private View.OnClickListener                    butOnClickListener = new View.OnClickListener() {
                                                                           ...
                                                                           public void onClick(View v) {
                                                                               ...
                                                                               dialog
                                                                                   .setLoginDialogListener(dialogListener);
                                                                               dialog
                                                                                   .show(
                                                                                       getFragmentManager(),
    ...
    protected void initListView(final int catalog, final PullToRefreshListView listView, int action) {
        final ListViewActiveAdapter lvActiveAdapter = new ListViewActiveAdapter(getActivity(),
            lvActiveData, R.layout.active_listitem);
        final View lvActive_footer = getActivity().getLayoutInflater().inflate(
            R.layout.listview_footer, null);
        final TextView lvActive_foot_more = (TextView) lvActive_footer
            .findViewById(R.id.listview_foot_more);
        final HandlerManager handlerUtil = HandlerManager.getInstance();
        mHandler = handlerUtil.getHandler(listView, lvActiveAdapter, lvActive_foot_more,
            abProgress, ActiveFragment.this, AppContext.PAGE_SIZE);
        ...
        refreshListener = new PullToRefreshListView.OnRefreshListener() {
            public void onRefresh() {
                ...
                } else if (catalog == ActiveList.CATALOG_COMMENT && bManager.isShowComment()) {
