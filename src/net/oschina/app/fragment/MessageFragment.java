...
public class MessageFragment extends ListFragment implements LoadListDataCallbacks {
    ...
    protected void initListView(final int catalog, final PullToRefreshListView listView, int action) {
        final ListViewMessageAdapter lvMsgAdapter = new ListViewMessageAdapter(getActivity(),
            lvMsgData, R.layout.message_listitem);
        final View lvMsg_footer = getActivity().getLayoutInflater().inflate(
        ...
        mHandler = handlerUtil.getHandler(listView, lvMsgAdapter, lvMsg_foot_more, abProgress,
