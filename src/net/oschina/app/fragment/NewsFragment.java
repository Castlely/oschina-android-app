...
public class NewsFragment extends ListFragment implements LoadListDataCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PullToRefreshListView lvNews = (PullToRefreshListView) layout
            .findViewById(R.id.fragment_test_listview);
    ...
    protected void initListView(final int catalog, final PullToRefreshListView listView, int action) {
        final View lvNews_footer = getActivity().getLayoutInflater().inflate(
            R.layout.listview_footer, null);
        final TextView lvNews_foot_more = (TextView) lvNews_footer
            .findViewById(R.id.listview_foot_more);
        // 初始化Handler
        ListViewNewsAdapter lvNewsAdapter = new ListViewNewsAdapter(getActivity(), lvNewsData,
            R.layout.news_listitem);
        HandlerManager handlerUtil = HandlerManager.getInstance();
        mHandler = handlerUtil.getHandler(listView, lvNewsAdapter, lvNews_foot_more, abProgress,
