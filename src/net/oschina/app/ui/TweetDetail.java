...
public class TweetDetail extends CustomActivity {
    ...
    private void initView() {
        ...
        if (curId > 0)
            tempCommentKey = AppConfig.TEMP_COMMENT + "_" + curCatalog + "_" + curId;
        ...
        audioLayout = (LinearLayout) lvHeader.findViewById(R.id.tweet_audio_layout);
        ...
        mLvComment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 跳转--回复评论界面
                UIHelper.showCommentReply(TweetDetail.this, curId, curCatalog, com.getId(),
        ...
        mLvComment.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (uid == com.getAuthorId()) {
                    ...
                    UIHelper.showCommentOptionDialog(TweetDetail.this, curId, curCatalog, com,
                        thread);
                } else {
                    UIHelper
                        .showCommentOptionDialog(TweetDetail.this, curId, curCatalog, com, null);
                }
                return true;
            }
        });
                ...
                if (msg.what == 1) {
                    ...
                    if (!StringUtils.isEmpty(attach)) {
                        ...
                        try {
                            ...
                            final AnimationDrawable anima = (AnimationDrawable) audio.getDrawable();
                            ...
                            UIHelper.ToastMessage(TweetDetail.this, R.string.msg_load_audio_fail);
                        }
                    }
                    // 发送通知广播
                    if (msg.obj != null) {
                                                             ...
                                                             public void onClick(View v) {
                                                                 if (tweetDetail != null)
                                                                     UIHelper.showUserCenter(
                                                                         v.getContext(),
                                                                         tweetDetail.getAuthorId(),
                                                                         tweetDetail.getAuthor());
                                                             }
                                                         };
    ...
    private View.OnClickListener commentpubClickListener = new View.OnClickListener() {
                                                             public void onClick(View v) {
                                                                 ...
                                                                 _content = mFootEditer.getText()
                                                                     .toString();
                                                                 if (StringUtils.isEmpty(_content)) {
                                                                     UIHelper.ToastMessage(
                                                                         v.getContext(), "请输入评论内容");
                                                                     return;
                                                                 }
