...
public class QuestionDetail extends CustomActivity implements FooterViewVisibility {
        ...
        mHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    mCommentCount.setText(postDetail.getAnswerCount() + "回/"
                                          + postDetail.getViewCount() + "阅");
                    ...
                    String body = UIHelper.WEB_STYLE + postDetail.getBody() + tags
    ...
    private void initCommentView() {
        ...
        mLvComment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //跳转--回复评论界面
                UIHelper.showCommentReply(QuestionDetail.this, curId, curCatalog, com.getId(),
                    com.getAuthorId(), com.getAuthor(), com.getContent());
            }
        });
        mLvComment.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollEnd && curLvDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    ...
                    loadLvCommentData(curId, curCatalog, pageIndex, mCommentHandler,
                ...
                if (uid == com.getAuthorId()) {
                    ...
                    final Thread thread = new Thread() {
                        public void run() {
                            Message msg = new Message();
                            try {
                                Result res = ac.delComment(curId, curCatalog, com.getId(),
                                    com.getAuthorId());
                                msg.what = 1;
                                msg.obj = res;
                            } catch (AppException e) {
                    ...
                    UIHelper.showCommentOptionDialog(QuestionDetail.this, curId, curCatalog, com,
                        thread);
                } else {
                    UIHelper.showCommentOptionDialog(QuestionDetail.this, curId, curCatalog, com,
                        null);
                                ...
                                for (Comment com1 : list.getCommentlist()) {
                                    ...
                                    for (Comment com2 : lvCommentData) {
                                        if (com1.getId() == com2.getId()
                                            && com1.getAuthorId() == com2.getAuthorId()) {
                                            b = true;
                                            break;
                                        }
                                    }
     ...
     * @param action 动作标识
     */
    private void loadLvCommentData(final int id, final int catalog, final int pageIndex,
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    CommentList commentlist = ((AppContext) getApplication()).getCommentList(
                        catalog, id, pageIndex, isRefresh);
    ...
    private TextWatcher          mTextWatcher               = new TextWatcher() {
                                                                ...
                                                                public void afterTextChanged(Editable s) {
                                                                    if (s.toString().equals("")) {
                                                                        mFootPubcomment
                                                                            .setImageResource(R.drawable.ic_footer_switch);
                                                                        mFootPubcomment
                                                                            .setOnClickListener(closeEditTextClickListener);
                                                                    } else {
                                                                        mFootPubcomment
                                                                            .setImageResource(R.drawable.ic_menu_send);
                                                                        mFootPubcomment
                                                                            .setOnClickListener(commentpubClickListener);
                                                                    }
                                                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.question_detail_share:
                ...
                UIHelper.showShareDialog(QuestionDetail.this, postDetail.getTitle(),
                    postDetail.getUrl());
                return true;
