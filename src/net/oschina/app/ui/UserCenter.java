...
public class UserCenter extends CustomActivity {
    ...
    private void initTabs() {
        ...
        active = actionBar.newTab().setText(R.string.software_lib_title_catalog)
            .setTabListener(tabListener);
        blog = actionBar.newTab().setText(R.string.software_lib_title_recommend)
            .setTabListener(tabListener);
    ...
    private void initLvBlog() {
        ...
        lvBlogAdapter = new ListViewBlogAdapter(this, BlogList.CATALOG_USER, lvBlogData,
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    UserInformation uinfo = ((AppContext) getApplication()).getInformation(_uid,
                        _hisuid, _hisname, pageIndex, isRefresh);
                    mUser = uinfo.getUser();
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    BlogList bloglist = ((AppContext) getApplication()).getUserBlogList(_hisuid,
                        _hisname, pageIndex, isRefresh);
    ...
    private void lvActiveHandleMessage(Message msg) {
        ...
        if (msg.arg1 == UIHelper.LISTVIEW_ACTION_REFRESH) {
            mLvActive.onRefreshComplete(getString(R.string.pull_to_refresh_update)
    ...
    private void lvBlogHandleMessage(Message msg) {
        ...
        if (msg.arg1 == UIHelper.LISTVIEW_ACTION_REFRESH) {
            mLvBlog.onRefreshComplete(getString(R.string.pull_to_refresh_update)
                                      + new Date().toLocaleString());
    ...
    private View.OnClickListener messageClickListener  = new View.OnClickListener() {
                                                           public void onClick(View v) {
                                                               if (mUser == null)
                                                                   return;
                                                               UIHelper.showMessagePub(
                                                                   UserCenter.this, mUser.getUid(),
                                                                   mUser.getName());
                                                           }
                                                       };
                                                                                   ...
                                                                                   case User.RELATION_TYPE_BOTH:
                                                                                       mRelation
                                                                                           .setCompoundDrawablesWithIntrinsicBounds(
                                                                                               R.drawable.widget_bar_relation_add,
                                                                                               0,
                                                                                               0, 0);
                                                                                       mRelation
                                                                                           .setText("加关注");
                                                                                       mUser
                                                                                           .setRelation(User.RELATION_TYPE_FANS_ME);
                                                                                       break;
                                                                                   case User.RELATION_TYPE_FANS_HIM:
                                                                                       mRelation
                                                                                           .setCompoundDrawablesWithIntrinsicBounds(
                                                                                       ...
                                                                                       mRelation
                                                                                           .setText("加关注");
                                                                                       mUser
                                                                                           .setRelation(User.RELATION_TYPE_NULL);
                                                                                       break;
                                                                                   case User.RELATION_TYPE_FANS_ME:
                                                                                       mRelation
                                                                                           .setCompoundDrawablesWithIntrinsicBounds(
                                                                                               R.drawable.widget_bar_relation_del,
                                                                                               0,
                                                                                               0, 0);
                                                                                       mRelation
                                                                                           .setText("取消互粉");
                                                                                       mUser
                                                                                           .setRelation(User.RELATION_TYPE_BOTH);
                                                                                       break;
                                                                                   case User.RELATION_TYPE_NULL:
                                                                                       mRelation
                                                                                           .setCompoundDrawablesWithIntrinsicBounds(
                                                                                       ...
                                                                                       mRelation
                                                                                           .setText("取消关注");
                                                                                       mUser
                                                                                           .setRelation(User.RELATION_TYPE_FANS_HIM);
                                                                                       break;
                                                                               }
                                                                           }
                                                                           UIHelper
