...
public class SoftwareLib extends BaseActionBarActivity {
    ...
    private void initTabs() {
        ...
        Tab catalog = mActionBar.newTab().setTag(HEAD_TAG_CATALOG)
            .setText(R.string.software_lib_title_catalog).setTabListener(tabListener);
        Tab recommend = mActionBar.newTab().setTag(HEAD_TAG_RECOMMEND)
            .setText(R.string.software_lib_title_recommend).setTabListener(tabListener);
        Tab lastest = mActionBar.newTab().setTag(HEAD_TAG_LASTEST)
            .setText(R.string.software_lib_title_lastest).setTabListener(tabListener);
        Tab hot = mActionBar.newTab().setTag(HEAD_TAG_HOT).setText(R.string.software_lib_title_hot)
            .setTabListener(tabListener);
        Tab china = mActionBar.newTab().setTag(HEAD_TAG_CHINA)
            .setText(R.string.software_lib_title_china).setTabListener(tabListener);
                                                  ...
                                                  public void onTabSelected(Tab arg0,
                                                      ...
                                                      if (HEAD_TAG_CATALOG == curHeadTag) {
                                                          ...
                                                          if (lvSoftwareCatalogData.size() == 0)
                                                              loadLvSoftwareCatalogData(
                                                                  0,
                                                                  mSoftwareCatalogHandler,
                                                      ...
                                                      mActionBar
                                                          .setTitle(longTitle.get(curHeadTag));
    ...
    private void initSoftwareCatalogListView() {
        lvSoftwareCatalogAdapter = new ListViewSoftwareCatalogAdapter(this, lvSoftwareCatalogData,
        ...
        mlvSoftwareCatalog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (type.tag > 0) {
                    ...
                    loadLvSoftwareCatalogData(type.tag, mSoftwareTagHandler,
                        UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG);
                }
            }
        });
    ...
    private void initSoftwareTagListView() {
        lvSoftwareTagAdapter = new ListViewSoftwareCatalogAdapter(this, lvSoftwareTagData,
            R.layout.softwarecatalog_listitem);
        ...
        mlvSoftwareTag.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (type.tag > 0) {
                    ...
                    loadLvSoftwareTagData(curSearchTag, 0, mSoftwareHandler,
                        UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG);
                }
            }
        });
    ...
    private void initSoftwareListView() {
        ...
        lvSoftwareAdapter = new ListViewSoftwareAdapter(this, lvSoftwareData,
            R.layout.software_listitem);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollEnd && curLvSoftwareDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    ...
                    if (curHeadTag == HEAD_TAG_CATALOG)
                        loadLvSoftwareTagData(curSearchTag, pageIndex, mSoftwareHandler,
                            UIHelper.LISTVIEW_ACTION_SCROLL);
                    else
                        loadLvSoftwareData(curHeadTag, pageIndex, mSoftwareHandler,
                            UIHelper.LISTVIEW_ACTION_SCROLL);
                }
            }
        ...
        mlvSoftware.setOnRefreshListener(new PullToRefreshListView.OnRefreshListener() {
            public void onRefresh() {
                if (curHeadTag == HEAD_TAG_CATALOG)
                    ...
                    loadLvSoftwareData(curHeadTag, 0, mSoftwareHandler,
                        UIHelper.LISTVIEW_ACTION_REFRESH);
            }
        });
        ...
        mSoftwareHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.arg1 == UIHelper.LISTVIEW_ACTION_REFRESH) {
                    mlvSoftware.onRefreshComplete(getString(R.string.pull_to_refresh_update)
    ...
    private void loadLvSoftwareCatalogData(final int tag, final Handler handler, final int action) {
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    SoftwareCatalogList softwareCatalogList = ((AppContext) getApplication())
     ...
     * @param action 动作标识
     */
    private void loadLvSoftwareTagData(final int searchTag, final int pageIndex,
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    SoftwareList softwareList = ((AppContext) getApplication()).getSoftwareTagList(
     ...
     * @param action 动作标识
     */
    private void loadLvSoftwareData(final int tag, final int pageIndex, final Handler handler,
                                    final int action) {
        ...
        if (StringUtils.isEmpty(_searchTag))
            return;
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    SoftwareList softwareList = ((AppContext) getApplication()).getSoftwareList(
                        searchTag, pageIndex, isRefresh);
