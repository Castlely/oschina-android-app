...
public class MessageDetail extends CustomActivity {
    ...
    private void initView() {
        ...
        if (curFriendId > 0)
            tempMessageKey = AppConfig.TEMP_MESSAGE + "_" + curFriendId;
        ...
        getSupportActionBar()
            .setTitle(getString(R.string.message_detail_head_title, curFriendName));
        ...
        lvCommentAdapter = new ListViewMessageDetailAdapter(this, lvCommentData,
        ...
        mLvComment.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollEnd && curLvDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    ...
                    loadLvCommentData(curFriendId, curCatalog, pageIndex, mHandler,
        ...
        mLvComment.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView username = (TextView) view
                    .findViewById(R.id.messagedetail_listitem_username);
                ...
                final Thread thread = new Thread() {
                    public void run() {
                        ...
                        try {
                            Result res = ((AppContext) getApplication()).delComment(curFriendId,
        ...
        mLvComment.setOnRefreshListener(new PullToRefreshListView.OnRefreshListener() {
            public void onRefresh() {
                loadLvCommentData(curFriendId, curCatalog, 0, mHandler,
