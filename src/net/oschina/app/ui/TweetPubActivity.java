...
public class TweetPubActivity extends BaseActionBarActivity {
    ...
    private View.OnTouchListener     recorderTouchListener   = new View.OnTouchListener() {
                                                                 ...
                                                                 public boolean onTouch(View v,
                                                                     ...
                                                                     if (IS_OVERTIME) {
                                                                         ...
                                                                         stopRecorder();
                                                                         mRecorder
                                                                             .setBackgroundResource(R.color.weight_bar_buttonup);
                                                                         mRecorder
                                                                             .setText("按住  说话");
                                                                         // 状态为取消
                                                                     ...
                                                                     switch (event.getAction()) {
                                                                         case MotionEvent.ACTION_DOWN:
                                                                             ...
                                                                             MediaPlayer md = MediaPlayer
                                                                                 .create(
                                                                                     TweetPubActivity.this,
                                                                             ...
                                                                             IS_OVERTIME = false;
                                                                             mRecorder
                                                                                 .setBackgroundResource(R.color.weight_bar_buttondown);
                                                                             mRecorder
                                                                                 .setText("松开  结束");
                                                                             // 按下时记录录音文件名
    ...
    private View.OnClickListener     atmeClickListener       = new View.OnClickListener() {
                                                                 public void onClick(View v) {
                                                                     ...
                                                                     showIMM();
                                                                     //在光标所在处插入“@用户名”
                                                                     int curTextLength = mContent
                                                                         .getText().length();
                                                                     if (curTextLength < MAX_TEXT_LENGTH) {
                                                                         String atme = TEXT_ATME;
                                                                         int start, end;
                                                                         if ((MAX_TEXT_LENGTH - curTextLength) >= atme
                                                                             .length()) {
                                                                             start = mContent
                                                                                 .getSelectionStart() + 1;
                                                                             end = start
    ...
    private View.OnClickListener     softwareClickListener   = new View.OnClickListener() {
                                                                 public void onClick(View v) {
                                                                     ...
                                                                     if (curTextLength < MAX_TEXT_LENGTH) {
                                                                         ...
                                                                         int start, end;
                                                                         if ((MAX_TEXT_LENGTH - curTextLength) >= software
                                                                             .length()) {
                                                                             start = mContent
                                                                                 .getSelectionStart() + 1;
                                                                             end = start
    ...
    public void imageChooseItem(CharSequence[] items) {
        AlertDialog imageDialog = new AlertDialog.Builder(this).setTitle(R.string.ui_insert_image)
            ...
            public void run() {
                ...
                if (requestCode == ImageUtils.REQUEST_CODE_GETIMAGE_BYSDCARD) {
                    ...
                    if (!"photo".equals(MediaUtils.getContentType(attFormat))) {
                        Toast.makeText(TweetPubActivity.this, getString(R.string.choose_image),
                    ...
                    if (AppContext.isMethodsCompat(android.os.Build.VERSION_CODES.ECLAIR_MR1)) {
                        ...
                        bitmap = ImageUtils.loadImgThumbnail(TweetPubActivity.this, imgName,
                ...
                if (bitmap != null) {
                    ...
                    if (largeFileName.startsWith("thumb_") && new File(largeFilePath).exists()) {
                        ...
                        if (new File(theThumbnail).exists()) {
                            ...
                            try {
                                //压缩上传的图片
                                ImageUtils.createImageThumbnail(TweetPubActivity.this, theLarge,
                                    theThumbnail, 800, 80);
                                imgFile = new File(theThumbnail);
                            } catch (IOException e) {
                                e.printStackTrace();
