 ...
 * @created 2012-3-21
 */
public class Search extends BaseActionBarActivity implements ActionBarProgressBarVisibility,
                                                 SearchContextListener {
    ...
    private FragmentPagerAdapter getAdapter() {
        ...
        SearchListFragment software = addBundle(new SearchListFragment(),
            SearchList.CATALOG_SOFTWARE);
    ...
    private void closeInputMethod() {
        imm.hideSoftInputFromWindow(mSearchEditer.getWindowToken(),
    ...
    class SearchPagerAdapter extends FragmentPagerAdapter {
        ...
        public SearchPagerAdapter(FragmentManager fm, List<SearchListFragment> fragments,
