...
public class FeedBack extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(R.string.feedback_publish, publishClickListener);
        builder.setNegativeButton(R.string.fragment_dialog_negative, new OnClickListener() {
