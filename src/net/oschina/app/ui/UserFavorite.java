...
public class UserFavorite extends BaseActionBarActivity {
    ...
    private void initTabs() {
        ...
        Tab catalog = mActionBar.newTab().setTag(FavoriteList.TYPE_SOFTWARE)
            .setText(R.string.software_lib_title_catalog).setTabListener(tabListener);
        Tab recommend = mActionBar.newTab().setTag(FavoriteList.TYPE_POST)
            .setText(R.string.software_lib_title_recommend).setTabListener(tabListener);
        Tab lastest = mActionBar.newTab().setTag(FavoriteList.TYPE_CODE)
            .setText(R.string.software_lib_title_lastest).setTabListener(tabListener);
        Tab hot = mActionBar.newTab().setTag(FavoriteList.TYPE_BLOG)
            .setText(R.string.software_lib_title_hot).setTabListener(tabListener);
        Tab china = mActionBar.newTab().setTag(FavoriteList.TYPE_NEWS)
    ...
    private void initView() {
        ...
        lvFavoriteAdapter = new ListViewFavoriteAdapter(this, lvFavoriteData,
            R.layout.favorite_listitem);
        ...
        mlvFavorite.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //点击头部、底部栏无效
                if (position == 0 || view == lvFavorite_footer)
                    return;
        ...
        mlvFavorite.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollEnd && curLvDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    ...
                    loadLvFavoriteData(curFavoriteCatalog, pageIndex, mFavoriteHandler,
        ...
        mlvFavorite.setOnRefreshListener(new PullToRefreshListView.OnRefreshListener() {
            public void onRefresh() {
                loadLvFavoriteData(curFavoriteCatalog, 0, mFavoriteHandler,
    ...
    private void initData() {
        mFavoriteHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.arg1 == UIHelper.LISTVIEW_ACTION_REFRESH) {
                    mlvFavorite.onRefreshComplete(getString(R.string.pull_to_refresh_update)
        ...
        this.loadLvFavoriteData(curFavoriteCatalog, 0, mFavoriteHandler,
     ...
     * @param action 动作标识
     */
    private void loadLvFavoriteData(final int type, final int pageIndex, final Handler handler,
                                    final int action) {
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    FavoriteList favoriteList = ((AppContext) getApplication()).getFavoriteList(
                        type, pageIndex, isRefresh);
