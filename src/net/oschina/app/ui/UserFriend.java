...
public class UserFriend extends BaseActionBarActivity {
    ...
    private void initView() {
        ...
        mlvFriend.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //点击头部、底部栏无效
                if (position == 0 || view == lvFriend_footer)
                    return;
        ...
        mlvFriend.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollEnd && curLvDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    ...
                    loadLvFriendData(curLvCatalog, pageIndex, mFriendHandler,
    ...
    private void initTabs() {
        ...
        followerTab = mActionBar.newTab().setTag(FriendList.TYPE_FOLLOWER)
            .setText(R.string.software_lib_title_catalog).setTabListener(tabListener);
        fansTab = mActionBar.newTab().setTag(FriendList.TYPE_FANS)
    ...
    private ActionBar.TabListener tabListener = new ActionBar.TabListener() {
                                                  ...
                                                  public void onTabSelected(Tab arg0,
                                                      ...
                                                      loadLvFriendData(curLvCatalog, 0,
                                                          mFriendHandler,
        ...
        mFriendHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.arg1 == UIHelper.LISTVIEW_ACTION_REFRESH) {
                    mlvFriend.onRefreshComplete(getString(R.string.pull_to_refresh_update)
        ...
        new Thread() {
            public void run() {
                ...
                if (action == UIHelper.LISTVIEW_ACTION_REFRESH
                    ...
                    isRefresh = true;
                try {
                    FriendList FriendList = ((AppContext) getApplication()).getFriendList(type,
                        pageIndex, isRefresh);
