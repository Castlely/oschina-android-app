...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(frame.left - 2.5f, frame.top, frame.left + 22, frame.top, paintCorner);
        canvas.drawLine(frame.left, frame.top, frame.left, frame.top + 22, paintCorner);
        canvas.drawLine(frame.right - 22, frame.top, frame.right + 2.5f, frame.top, paintCorner);
        canvas.drawLine(frame.right, frame.top, frame.right, frame.top + 22, paintCorner);
        canvas
            .drawLine(frame.left - 2.5f, frame.bottom, frame.left + 22, frame.bottom, paintCorner);
        canvas.drawLine(frame.left, frame.bottom - 22, frame.left, frame.bottom, paintCorner);
        canvas.drawLine(frame.right - 22, frame.bottom, frame.right + 2.5f, frame.bottom,
            paintCorner);
        canvas.drawLine(frame.right, frame.bottom - 22, frame.right, frame.bottom, paintCorner);
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawBitmap(((BitmapDrawable) (getResources()
                .getDrawable(R.drawable.qrcode_scan_line))).getBitmap(), null, lineRect, paint);
