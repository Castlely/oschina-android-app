...
public class Weibo {
     ...
     * 分享到微博
     */
    public boolean shareToweibo(Activity activity, String accessToken, String tokenSecret,
     ...
     * 分享到微博 ,带图片
     */
    public boolean shareToweiboWithFile(Activity context, String accessToken, String tokenSecret,
                                        String content, String fileUrl) throws WeiboException {
        Utility.setAuthorization(new Oauth2AccessTokenHeader());
        WeiboParameters bundle = new WeiboParameters();
        bundle.add("source", APP_KEY);
        bundle.add("status", content);
