...
public class QuickActionBar extends QuickActionWidget {
    ...
    protected void populateQuickActions(List<QuickAction> quickActions) {
        ...
        for (QuickAction action : quickActions) {
            TextView view = (TextView) inflater.inflate(R.layout.gd_quick_action_bar_item,
                mQuickActionItems, false);
    ...
    private OnClickListener mClickHandlerInternal = new OnClickListener() {
                                                      ...
                                                      public void onClick(View view) {
                                                          ...
                                                          if (listener != null) {
                                                              final int itemCount = mQuickActions
                                                                  .size();
                                                              for (int i = 0; i < itemCount; i++) {
                                                                  if (view == mQuickActions.get(i).mView
                                                                      .get()) {
                                                                      listener
