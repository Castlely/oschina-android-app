...
public class TabButton extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLinearLayout.getChildCount(); i++) {
            ...
            canvas.drawRect(view.getLeft() - 1f, pianyi, view.getLeft(), layoutHeight - pianyi,
                dividerPaint);
            //width = view.getWidth();
        }
        // 绘制滑块
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mButtonBackground = tArray.getResourceId(R.styleable.TabButton_buttonBackground,
            R.drawable.background_tabs);

        int bottomLineColor = tArray
            .getColor(R.styleable.TabButton_bottomLineColor, DEF_LINE_COLOR);
        ...
        float defBottonLineSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
            DEF_BOTTON_LINE_SIZE, getResources().getDisplayMetrics());
        float defDividerSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
            DEF_DIVIDER_SIZE, getResources().getDisplayMetrics());
        float defSliderSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
            DEF_SLIDER_SIZE, getResources().getDisplayMetrics());
        float defTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, DEF_TEXT_SIZE,
            getResources().getDisplayMetrics());
        tabPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEF_TAB_PADDING,
            getResources().getDisplayMetrics());

        bottomLineSize = tArray.getDimension(R.styleable.TabButton_bottomLineSize,
            defBottonLineSize);
    ...
    private OnClickListener buttonOnClick = new OnClickListener() {
                                              ...
                                              public void onClick(View v) {
                                                  if (onClickListener != null) {
                                                      onClickListener.tabsButtonOnClick(v.getId(),
                                                          v);
