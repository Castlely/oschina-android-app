...
import cn.gov.psxq.common.QQWeiboHelper2;
import cn.gov.psxq.common.SinaWeiboHelper;
...
public class ScreenShotShare extends BaseActionBarActivity {
    ...
    private void shareToSinaWeibo(String content, final String imagePath) {
        ...
        if (access != null) {
            ...
            SinaWeiboHelper.progressDialog.setMessage(this.getString(R.string.sharing));
            ...
            new Thread() {
                public void run() {
                    ...
                    SinaWeiboHelper.shareMessage(ScreenShotShare.this, shareMsg, imagePath);
                }
            }.start();
        } else {
            SinaWeiboHelper.authorize(ScreenShotShare.this, shareMsg, imagePath);
        }
    }
