...
public class QQWeiboHelper2 {
                                         ...
                                         case SEND:
                                             ...
                                             if (getReturnMsg(data, "ret").equals("0")) {
                                                 UIHelper.ToastMessage(context, "分享成功");
                                                        ...
                                                        && getReturnMsg(data, "errcode")
                                                            .equals("4")) {
                                                 authenticate(); // 重新认证
                                             } else {
                                                 UIHelper.ToastMessage(context,
                                                     getReturnMsg(data, "msg"));
                                             }
                                             break;
                                     }
                                 };
     ...
     * 
     */
    public void onAuthorizeWebViewReturn(int requestCode, int resultCode, Intent data) {
    ...
    private void sendMessage() {
        new Thread() {
            public void run() {
                ...
                try {
                    msg.obj = tAPI.addPic(oAuth, "json", mContent, "127.1.1.1", mPicPath);
                } catch (Exception e) {
                    e.printStackTrace();
                }
