                                          ...
                                          switch (msg.what) {
                                              case OAUTH_ERROR:
                                                  Toast.makeText(context,
                                                      context.getString(R.string.OAUTH_ERROR),
                                              ...
                                              case OAUTH_RequestToken_ACCESS:
                                                  Toast
                                                      .makeText(
                                                          context,
                                                          context
                                                              .getString(R.string.OAUTH_RequestToken_ACCESS),
                                                          Toast.LENGTH_SHORT).show();
                                                  break;
                                              case OAUTH_RequestToken_ERROR:
                                                  Toast
                                                      .makeText(
                                                          context,
                                                          context
                                                              .getString(R.string.OAUTH_RequestToken_ERROR),
                                                          Toast.LENGTH_SHORT).show();
                                                  break;
                                              ...
                                              case OAUTH_AccessToken_SXPIRED:
                                                  Toast
                                                      .makeText(
                                                          context,
                                                          context
                                                              .getString(R.string.OAUTH_AccessToken_SXPIRED),
                                                          Toast.LENGTH_SHORT).show();
                                                  authorize(context, shareMessage, shareImage);//跳转到授权页面
                                                  break;
                                              case Weibo_Message_NULL:
                                                  Toast.makeText(
                                                      context,
                                                      context
                                                          .getString(R.string.Weibo_Message_NULL),
                                                      Toast.LENGTH_SHORT).show();
                                                  break;
                                              case Weibo_Message_LONG:
                                                  Toast.makeText(
                                                      context,
                                                      context
                                                          .getString(R.string.Weibo_Message_LONG),
                                                      Toast.LENGTH_SHORT).show();
                                                  break;
                                              case Weibo_Share_Success:
                                                  Toast.makeText(
                                                      context,
                                                      context
                                                          .getString(R.string.Weibo_Share_Success),
                                                      Toast.LENGTH_SHORT).show();
                                                  break;
                                              case Weibo_Share_Error:
                                                  Toast
                                                      .makeText(
                                                          context,
                                                          context
                                                              .getString(R.string.Weibo_Share_Error),
                                                          Toast.LENGTH_SHORT).show();
                                                  break;
                                              case Weibo_Share_Repeat:
                                                  Toast.makeText(
                                                      context,
                                                      context
                                                          .getString(R.string.Weibo_Share_Repeat),
                                                      Toast.LENGTH_SHORT).show();
                                                  break;
                                          }
                                      };
        ...
        weibo.authorize(cont, new WeiboDialogListener() {
            ...
            public void onComplete(Bundle values) {
                try {
                    ...
                    //保存AccessToken
                    AppConfig.getAppConfig(cont).setAccessInfo(accessToken.getToken(),
                        accessToken.getSecret(), accessToken.getExpiresIn());
                    //微博分享
    ...
    public static void shareMessage(Activity cont, String shareMsg, String shareImg) {
        ...
        try {
            if (StringUtils.isEmpty(shareImage)) {
                weibo.shareToweibo(cont, accessToken.getToken(), accessToken.getSecret(),
                    shareMessage);
            } else {
                weibo.shareToweiboWithFile(cont, accessToken.getToken(), accessToken.getSecret(),
                    shareMessage, shareImage);
            }
