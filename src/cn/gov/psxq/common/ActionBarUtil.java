...
public class ActionBarUtil {
    ...
    public static ProgressBar getProgressBar(ActionBarActivity activity) {
        ...
        progressBar.setPadding(PADDING_HORIZONTAL, PADDING_VERCATIL, PADDING_HORIZONTAL,
            PADDING_VERCATIL);
    ...
    public static ActionBar.LayoutParams getActionViewLayoutParams() {
        return new ActionBar.LayoutParams(BUTTON_WIDTH, BUTTON_HEIGTH, Gravity.CENTER
                                                                       | Gravity.RIGHT);
    }
}
