    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setPositiveButton(R.string.fragment_dialog_positive, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                AutoCompleteTextView accountView = (AutoCompleteTextView) layout
                    .findViewById(R.id.login_account);
                EditText passwordView = (EditText) layout.findViewById(R.id.login_password);
                CheckBox rememberMe = (CheckBox) layout
                    .findViewById(R.id.login_checkbox_rememberMe);
        ...
        final Handler handler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    UIHelper.ToastMessage(appContext, appContext.getString(R.string.msg_login_fail)
                                                      + msg.obj);
                    if (listener != null) {
