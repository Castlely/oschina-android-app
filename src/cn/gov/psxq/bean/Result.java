...
import cn.gov.psxq.bean.Comment.Refer;
import cn.gov.psxq.bean.Comment.Reply;
                ...
                switch (evtType) {
                        ...
                        if (tag.equalsIgnoreCase("result")) {
                            ...
                            if (tag.equalsIgnoreCase("errorCode")) {
                                ...
                                if (tag.equalsIgnoreCase("id")) {
                                    ...
                                    res.comment.setAuthorId(StringUtils.toInt(xmlParser.nextText(),
                                        0));
                                    ...
                                    res.comment.setAppClient(StringUtils.toInt(
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if (tag.equalsIgnoreCase("reply") && res.comment != null && reply != null) {
                            ...
                            reply = null;
                        } else if (tag.equalsIgnoreCase("refer") && res.comment != null
                                   && refer != null) {
