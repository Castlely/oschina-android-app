...
import cn.gov.psxq.bean.Update;
import cn.gov.psxq.bean.User;
import cn.gov.psxq.bean.UserInformation;
import cn.gov.psxq.bean.WellcomeImage;
...
public class ApiClient {
     ...
     * @throws  
     */
    private static Result http_post(AppContext appContext, String url, Map<String, Object> params,
                                    Map<String, File> files) throws AppException, IOException {
    ...
    public static void checkBackGround(AppContext appContext) throws AppException {
        try {
            ...
            if (update.isUpdate()) {
                ...
                ImageUtils.saveImageToSD(appContext, filePath + fileName + ".png", photo, 100);
            } else {
    ...
    public static Information getInformationDetail(AppContext appContext,
                                                   final String information_id) throws AppException {

        try {
            Gson gson = AppData.gsonBuilder.create();
            return gson.fromJson(AppData.get("information_" + information_id, appContext),
                Information.class);
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
     ...
     * @throws AppException
     */
    public static TweetList getTweetList(AppContext appContext, final int uid, final int pageIndex,
                                         final int pageSize) throws AppException {
     ...
     * @throws AppException
     */
    public static Result forwardMessage(AppContext appContext, int uid, String receiverName,
     ...
     * @throws AppException
     */
    public static Result replyBlogComment(AppContext appContext, int blog, int uid, String content,
     ...
     * @throws AppException
     */
    public static Result delBlogComment(AppContext appContext, int uid, int blogid, int replyid,
     ...
     * @throws AppException
     */
    public static Result pubComment(AppContext appContext, int catalog, int id, int uid,
                                    String content, int isPostToMyZone) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
     ...
     * @throws AppException
     */
    public static Result replyComment(AppContext appContext, int id, int catalog, int replyid,
                                      int authorid, int uid, String content) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("catalog", catalog);
        params.put("id", id);
        params.put("uid", uid);
     ...
     * @throws AppException
     */
    public static Result delComment(AppContext appContext, int id, int catalog, int replyid,
                                    int authorid) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("id", id);
        params.put("catalog", catalog);
        params.put("replyid", replyid);
     ...
     * @throws AppException
     */
    public static SearchList getSearchList(AppContext appContext, String catalog, String content,
